...
static char Color_enhancement[33]= {
	...
	0x10, 0x10, 0x10, 0x10,
	0x10};
static char monarudo_Color_enhancement[33]= {
        0xCA, 0x01, 0x02, 0x9A,
        0xA4, 0xB8, 0xB4, 0xB0,
        0xA4, 0x08, 0x28, 0x05,
        0x87, 0xB0, 0x50, 0x01,
...
static struct dsi_cmd_desc sharp_video_on_cmds[] = {
	...
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(monarudo_Color_enhancement), monarudo_Color_enhancement},
...
static void monarudo_color_enhance(struct msm_fb_data_type *mfd, int on)
{
...
static struct msm_fb_panel_data monarudo_panel_data = {
	...
	.color_enhance = monarudo_color_enhance,
};
